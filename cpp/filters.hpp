...
template<typename T>
void highcut(T fhi, int nphi, int phase, long long n1, T *data, T *newdata, T *tempdata)
{
	int nodd,nb,j;
	T *b;
	T a,aa,aap4,dtheta,theta0;
	double c;
...
*                                                                            *
*  USAGE                                                                     *
*  void lowcut(float flo,int nplo,int phase,int n1,float *data,              *
...
template<typename T>
void lowcut(T flo, int nplo, int phase, long long n1, T *data, T *newdata, T *tempdata)
{
	int nodd,nd,j;
	T *d;
	T a,aa,aap4,dtheta,theta0,b1,b2,b3,den,e,ee,fno2;
	double c;
	long long ilo,i1;
